 ...
 */
class Advertise_Importer_Block_Adminhtml_Job_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Constructor
     */
    ...
    {
        $collection = Mage::getModel('importer/job')->getCollection();
